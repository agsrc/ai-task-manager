...
## 📜 Project Evolution
TaskArchitect began as a foundational CRUD application to explore the Quarkus + React integration.
As the project shifted toward AI-driven automation and performance telemetry, the original
specifications were moved to the archive.

View the **[Project Archive](./docs/original_readme.md)** for the initial v1.0 setup and goals.
